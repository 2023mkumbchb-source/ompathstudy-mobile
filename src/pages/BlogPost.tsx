...
export default function BlogPost() {
  ...
  useLayoutEffect(() => {
    ...
    // Only restore a reload when the caller explicitly opted in. Normal note
    // opens and app restarts should present the title, not an old deep scroll.
    const restoreReloadPosition = sessionStorage.getItem("restore_article_scroll") === "1";
    if (isReload && slug && restoreReloadPosition) {
      sessionStorage.removeItem("restore_article_scroll");
